...
<script
	...
	<body>
		<nav class="bg-light p-2">
				...
				<a href="#" role="button" class="btn btn-primary" onclick="goBack()">Về danh sách bài viết</a>
		...
		<main class="container item-border p-5">
					<form:form modelAttribute="post" action="${pageContext.request.contextPath}/editPost">
					...
					<input type="text" class="form-control" name="address" value="${companyAddress}" readonly="readonly">
					
					<p style="margin:10px 0px 0px 0px">Nơi tuyển dụng</p>
					<input type="text" class="form-control" name="location" value="${post.location}" readonly="readonly">
